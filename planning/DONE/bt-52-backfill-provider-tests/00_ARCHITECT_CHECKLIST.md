...
- [ ] **Related ticket**: bp-52 (Unify Providers) is completed before starting this backfill
...
- [ ] I have checked existing test files: `backend/src/__tests__/`, `frontend/src/__tests__/`, `frontend/cypress/`
