...
- [ ] **Related ticket**: bp-59 (CI & Docker Infra) is completed before starting this backfill

### Existing Infrastructure Audit

- [ ] I have checked if the **CI pipeline** already exists (`.github/workflows/ci.yml`)
- [ ] I have checked if the **Dockerfiles** already exist (`backend/Dockerfile`, `agent/Dockerfile`)
- [ ] I have checked if the **Docker Compose files** already exist
- [ ] I have checked if there are **existing test patterns** I should follow
- [ ] I have checked existing test files: `backend/src/__tests__/`
